...
public class ContactUsUtil {
		...
		public void sendMail(String Str){
			...
			try {
				...
				message.setRecipient(MimeMessage.RecipientType.TO,new InternetAddress("1428383239@qq.com","用户","UTF-8"));
				message.setSubject("客户联系信息", "UTF-8" );
				message.setContent("客户联系信息为："+Str,"text/html;charset=UTF-8");
