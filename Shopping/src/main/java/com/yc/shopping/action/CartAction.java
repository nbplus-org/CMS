...
public class CartAction {
    ...
    public void checkNum(Model model,Integer qty,String color,String size,Integer clothesid,HttpServletResponse response,HttpServletRequest request){
    ...
    public void changeNum(String num,Integer cartid,Double clothesprice,Integer cnum,HttpServletRequest request,HttpServletResponse response){
