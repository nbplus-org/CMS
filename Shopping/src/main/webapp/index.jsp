					...
					<div class="middle-text">
						<div class="width-cap">
							...
							<div class="slider2-shop slider2-shop_home2">
								<a href="showShop.do?op=search&value=耐克">不要犹豫，放肆起来！</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="middle-text">
						<div class="width-cap">
							...
							<div class="slider-readmore">
								<a href="showShop.do?op=search&value=裙子">半腰短袖</a>
							</div>
							<div class="slider-shopping">
								<a href="showShop.do?op=search&value=裙子">不要犹豫</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="middle-text">
						<div class="width-cap">
							...
							<div class="slider2-readmore">
								<a href="showShop.do?op=search&value=包包">MK时尚女包</a>
							</div>
							<div class="slider2-shop">
								<a href="showShop.do?op=search&value=包包">立刻买吧</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="home2_banner_single">
						<div class="home2_banner_one">
							<a href="showShop.do?op=tag&clothesbigtag=包包"> <img src="img/banner/banner-1.jpg" alt="banner" />
							</a>
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="home2_banner_single">
						<div class="home2_banner_one">
							<a href="showShop.do?op=tag&clothesbigtag=女装"> <img src="img/banner/banner-2.jpg" alt="banner" />
							</a>
						</div>
						<div class="home2_banner_text">
							<h4>品牌服装</h4>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="home2_banner_single">
						<div class="home2_banner_one">
							<a href="showShop.do?op=tag&clothesbigtag=鞋子"> <img src="img/banner/banner-3.jpg" alt="banner" />
							</a>
						</div>
						<div class="home2_banner_text">
							<h4>潮流鞋</h4>
