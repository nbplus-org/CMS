						...
						<div class="home2_contact_info">
							...
							<div class="account_card_area account_cart_home2"> 
								<ul id="account_nav">
									...
									<li><a class="list_cl" href="cart.html"><i class="fa fa-shopping-cart"></i>购物车 <span class="cart_zero cart_zero1">2</span></a>
		...
		<section class="slider-area">
			...
			<div class="slider home2_slider">
				<div id="mainSlider" class="nivoSlider nevo-slider">
					<img src="img/slider/slider-3.jpg" alt="main slider" title="#htmlcaption0"/>
				...
				<div id="htmlcaption0" class="nivo-html-caption slider-caption">
					...
					<div class="slider-text">
						<div class="middle-text">
							<div class="width-cap">
								<h3 class="slider2-tiile-top home2_slider2-tiile-top top-ani-2"><span>纯手工制作</span></h3>
								<h2 class="slider2-tiile-middle home2_slider2-tiile-middle middle-ani-2"><span>真皮皮袋</span></h2>
				...
				<div id="htmlcaption1" class="nivo-html-caption slider-caption">
					...
					<div class="slider-text">
						<div class="middle-text">
							<div class="width-cap">
								<h3 class="slider-tiile-top top-ani-1"><span>疯狂夏日</span></h3>
								<h2 class="slider-tiile-middle middle-ani-1"><span>开始</span></h2>
				...
				<div id="htmlcaption2" class="nivo-html-caption slider-caption">
					...
					<div class="slider-text">
						<div class="middle-text">
							<div class="width-cap">
								<h3 class="slider2-tiile-top top-ani-2"><span>纯手工制作</span></h3>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="product_list">
							<div class="single_product">
								<a href="product.html" target="main"><img src="img/feature-image/1.jpg" alt="" /></a>
				...
				<div class="row">
					<div class="product_bottom_area">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product_list">
								<div class="single_product">
									<a href="product.html" target="main"><img src="img/feature-image/11_1.jpg" alt="" /></a>
									<div class="product_details">
										<h2>Lorem ipsum dolor</h2>
										<p><span class="regular_price">$170.00</span> <span class="popular_price">$150.00</span></p>
									</div>
				...
				<div class="row">
					<div class="product_bottom_area">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product_list">
								<div class="single_product">
									<a href="product.html" target="main"><img src="img/feature-image/14_3.jpg" alt="" /></a>
									<div class="product_details">
										<h2>Lorem ipsum dolor</h2>
										<p><span class="regular_price">$170.00</span> <span class="popular_price">$150.00</span></p>
									</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product_list">
								<div class="single_product">
									<a href="product.html" target="main"><img src="img/feature-image/16.jpg" alt="" /></a>
									<div class="product_details">
										<h2>Lorem ipsum dolor</h2>
										<p><span class="regular_price">$170.00</span> <span class="popular_price">$150.00</span></p>
									</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product_list">
								<div class="single_product">
									<a href="product.html" target="main"><img src="img/feature-image/17_2_1_1.jpg" alt="" /></a>
									<div class="product_details">
										<h2>Lorem ipsum dolor</h2>
										<p><span class="regular_price">$170.00</span> <span class="popular_price">$150.00</span></p>
									</div>
